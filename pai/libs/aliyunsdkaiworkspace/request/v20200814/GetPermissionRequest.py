...
class GetPermissionRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'AIWorkSpace', '2020-08-14', 'GetPermission')
		self.set_uri_pattern('/api/core/v1.0/permissions/[PermissionCode]')
		self.set_method('GET')
