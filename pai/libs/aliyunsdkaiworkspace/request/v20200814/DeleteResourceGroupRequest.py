...
class DeleteResourceGroupRequest(RoaRequest):
	...
	def __init__(self):
		RoaRequest.__init__(self, 'AIWorkSpace', '2020-08-14', 'DeleteResourceGroup')
	...
	def get_ResourceGroupProductType(self):
		return self.get_query_params().get('ResourceGroupProductType')

	def set_ResourceGroupProductType(self,ResourceGroupProductType):
		self.add_query_param('ResourceGroupProductType',ResourceGroupProductType)
	...
	def get_ResourceGroupMode(self):
		return self.get_query_params().get('ResourceGroupMode')

	def set_ResourceGroupMode(self,ResourceGroupMode):
		self.add_query_param('ResourceGroupMode',ResourceGroupMode)